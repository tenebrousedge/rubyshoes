...
Gem::Specification.new do |spec|
  spec.name          = 'rubyshoes'
  spec.version       = Rubyshoes::VERSION
  spec.authors       = ['Patrick Leahy']
  spec.email         = ['tenebrousedge@gmail.com']

  spec.summary = 'Student Project: Shoe-related app with Sinatra & ActiveRecord'
  spec.homepage = 'https://github.com/tenebrousedge/rubyshoes'
  spec.license = 'MIT'
